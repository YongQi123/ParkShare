...
import torch.nn.ModuleList;
import torch.nn.NewPackage1Factory;
import torch.nn.NewPackage1Package;

/**
 * This is the item provider adapter for a {@link torch.nn.ModuleList} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleListItemProvider extends ModuleItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NewPackage1Package.Literals.MODULE_LIST__MODULE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case NewPackage1Package.MODULE_LIST__MODULE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(NewPackage1Package.Literals.MODULE_LIST__MODULE,
