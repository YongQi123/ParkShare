...
/**
 * This is the item provider adapter for a {@link torch.nn.Sequential} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequentialItemProvider extends ModuleItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NewPackage1Package.Literals.SEQUENTIAL__MODULE);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Sequential_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Sequential.class)) {
		case NewPackage1Package.SEQUENTIAL__MODULE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(NewPackage1Package.Literals.SEQUENTIAL__MODULE,
