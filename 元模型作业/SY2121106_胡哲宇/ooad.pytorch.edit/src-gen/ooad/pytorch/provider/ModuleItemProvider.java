...
/**
 * This is the item provider adapter for a {@link ooad.pytorch.Module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						PytorchPackage.Literals.MODULE__NAME, true, false, false,
	...
	protected void addNextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Module_next_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Module_next_feature", "_UI_Module_type"),
						PytorchPackage.Literals.MODULE__NEXT, true, false, true, null, null, null));
	}
	...
	protected void addPrevPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Module_prev_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Module_prev_feature", "_UI_Module_type"),
						PytorchPackage.Literals.MODULE__PREV, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((ooad.pytorch.Module) object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ooad.pytorch.Module.class)) {
